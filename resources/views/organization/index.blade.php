						...
						<div class="page-header">
							<div class="page-leftheader">
								<h4 class="page-title mb-0">Hi! Welcome Back {{ Auth::check() ? auth('employee')->user()->name : 'user'}}</h4>
								<ol class="breadcrumb">
									...
									<div class="card-body">
										<div class="latest-timeline scrollbar3" id="scrollbar3">
											<ul class="timeline mb-0">
												<li class="mt-0">
													<div class="d-flex"><span class="time-data">Task Finished</span><span class="mr-auto text-muted fs-11">09 June 2020</span></div>
												...
												<li>
													<div class="d-flex"><span class="time-data">New Comment</span><span class="mr-auto text-muted fs-11">05 June 2020</span></div>
												...
												<li>
													<div class="d-flex"><span class="time-data">Target Completed</span><span class="mr-auto text-muted fs-11">01 June 2020</span></div>
												...
												<li>
													<div class="d-flex"><span class="time-data">Revenue Sources</span><span class="mr-auto text-muted fs-11">26 May 2020</span></div>
												...
												<li>
													<div class="d-flex"><span class="time-data">Dispatched Order</span><span class="mr-auto text-muted fs-11">22 May 2020</span></div>
												...
												<li>
													<div class="d-flex"><span class="time-data">New User Added</span><span class="mr-auto text-muted fs-11">19 May 2020</span></div>
												...
												<li>
													<div class="d-flex"><span class="time-data">Revenue Sources</span><span class="mr-auto text-muted fs-11">15 May 2020</span></div>
												...
												<li class="mb-0">
													<div class="d-flex"><span class="time-data">New Order Placed</span><span class="mr-auto text-muted fs-11">11 May 2020</span></div>
									...
									<div class="card-body">
											...
											<div class="row align-items-center">
												<div class="col-9 col-sm-9">
													<div class="media mt-0">
														<img src="{{URL::asset('assets/images/users/1.jpg')}}" alt="img" class="avatar brround avatar-md">
										...
										<div class="list-card">
											...
											<div class="row align-items-center">
												<div class="col-9 col-sm-9">
													<div class="media mt-0">
														<img src="{{URL::asset('assets/images/users/9.jpg')}}" alt="img" class="avatar brround avatar-md">
														<div class="media-body mr-3">
															<div class="d-md-flex align-items-center mt-1">
										...
										<div class="list-card">
											...
											<div class="row align-items-center">
												<div class="col-9 col-sm-9">
													<div class="media mt-0">
														<img src="{{URL::asset('assets/images/users/2.jpg')}}" alt="img" class="avatar brround avatar-md">
														<div class="media-body mr-3">
															<div class="d-md-flex align-items-center mt-1">
										...
										<div class="list-card">
											...
											<div class="row align-items-center">
												<div class="col-9 col-sm-9">
													<div class="media mt-0">
														<img src="{{URL::asset('assets/images/users/11.jpg')}}" alt="img" class="avatar brround avatar-md">
														<div class="media-body mr-3">
															<div class="d-md-flex align-items-center mt-1">
										...
										<div class="list-card">
											...
											<div class="row align-items-center">
												<div class="col-9 col-sm-9">
													<div class="media mt-0">
														<img src="{{URL::asset('assets/images/users/3.jpg')}}" alt="img" class="avatar brround avatar-md">
														<div class="media-body mr-3">
															<div class="d-md-flex align-items-center mt-1">
																<h6 class="mb-1">Joseph Abraham</h6>
															</div>
								...
								<div class="card">
									...
									<div class="card-body">
										<div class="country-card">
											<div class="mb-5">
												<div class="d-flex">
													<span class=""><img src="{{URL::asset('assets/images/flags/us.svg')}}" class="w-5 h-5 ml-2" alt="">United States</span>
													<div class="mr-auto"><span class="text-success mr-1"><i class="fe fe-trending-up"></i></span><span class="number-font">$45,870</span> (86%)</div>
												</div>
											...
											<div class="mb-5">
												<div class="d-flex">
													<span class=""><img src="{{URL::asset('assets/images/flags/in.svg')}}" class="w-5 h-5 ml-2" alt="">India</span>
													<div class="mr-auto"><span class="text-danger mr-1"><i class="fe fe-trending-down"></i></span><span class="number-font">$32,879</span> (65%)</div>
												</div>
												<div class="progress h-2  mt-1">
											...
											<div class="mb-5">
												<div class="d-flex">
													<span class=""><img src="{{URL::asset('assets/images/flags/ru.svg')}}" class="w-5 h-5 ml-2" alt="">Russia</span>
													<div class="mr-auto"><span class="text-success mr-1"><i class="fe fe-trending-up"></i></span><span class="number-font">$22,710</span> (55%)</div>
												</div>
												<div class="progress h-2  mt-1">
											...
											<div class="mb-5">
												<div class="d-flex">
													<span class=""><img src="{{URL::asset('assets/images/flags/ca.svg')}}" class="w-5 h-5 ml-2" alt="">Canada</span>
													<div class="mr-auto"><span class="text-danger mr-1"><i class="fe fe-trending-down"></i></span><span class="number-font">$56,291</span> (69%)</div>
												</div>
												<div class="progress h-2  mt-1">
											...
											<div class="mb-5">
												<div class="d-flex">
													<span class=""><img src="{{URL::asset('assets/images/flags/ge.svg')}}" class="w-5 h-5 ml-2" alt="">Germany</span>
													<div class="mr-auto"><span class="text-success mr-1"><i class="fe fe-trending-up"></i></span><span class="number-font">$67,357</span> (73%)</div>
												</div>
												<div class="progress h-2  mt-1">
											...
											<div class="mb-5">
												<div class="d-flex">
													<span class=""><img src="{{URL::asset('assets/images/flags/br.svg')}}" class="w-5 h-5 ml-2" alt="">Brazil</span>
													<div class="mr-auto"><span class="text-success mr-1"><i class="fe fe-trending-up"></i></span><span class="number-font">$34,209</span> (60%)</div>
												</div>
												<div class="progress h-2  mt-1">
											...
											<div class="mb-0">
												<div class="d-flex">
													<span class=""><img src="{{URL::asset('assets/images/flags/au.svg')}}" class="w-5 h-5 ml-2" alt="">Australia</span>
													<div class="mr-auto"><span class="text-success mr-1"><i class="fe fe-trending-up"></i></span><span class="number-font">$12,876</span> (46%)</div>
												</div>
												<div class="progress h-2  mt-1">
									...
									<div class="card-body">
										<div class="d-flex align-items-end justify-content-between">
											<div>
												...
												<h2 class="mb-0"><span class="number-font1">12,769</span><span class="mr-2 text-muted fs-11"><span class="text-danger"><i class="fa fa-caret-down"></i> 43.2</span> this month</span></h2>
										...
										<div class="d-flex mt-4">
											<div>
												<span class="text-muted fs-12 ml-1">Last Month</span>
												<span class="number-font fs-12"><i class="fa fa-caret-up mr-1 text-success"></i>10,876</span>
											</div>
											<div class="mr-auto">
												<span class="text-muted fs-12 ml-1">Last Year</span>
									...
									<div class="card-body">
										<div class="d-flex align-items-end justify-content-between">
											<div>
												...
												<h2 class="mb-0"><span class="number-font1">$34,789</span><span class="mr-2 text-muted fs-11"><span class="text-success"><i class="fa fa-caret-up"></i> 19.8</span> this month</span></h2>
											</div>
									...
									<div class="card-body">
										<div class="d-flex align-items-end justify-content-between">
											<div>
												...
												<h2 class="mb-0"><span class="number-font1">4,876</span><span class="mr-2 text-muted fs-11"><span class="text-success"><i class="fa fa-caret-up"></i> 0.8%</span> this month</span></h2>
											</div>
									...
									<div class="card-body">
										<div class="table-responsive">
											<table class="table table-vcenter text-nowrap mb-0 table-striped table-bordered border-top">
												...
												<tbody>
													<tr>
														<td class="font-weight-bold"><img class="w-7 h-7 rounded shadow ml-3" src="{{URL::asset('assets/images/orders/7.jpg')}}" alt="media1"> New Book</td>
													...
													<tr>
														<td class="font-weight-bold"><img class="w-7 h-7 rounded shadow ml-3" src="{{URL::asset('assets/images/orders/8.jpg')}}" alt="media1"> New Bowl</td>
													...
													<tr>
														<td class="font-weight-bold"><img class="w-7 h-7 rounded shadow ml-3" src="{{URL::asset('assets/images/orders/9.jpg')}}" alt="media1"> Modal Car</td>
													...
													<tr>
														<td class="font-weight-bold"><img class="w-7 h-7 rounded shadow ml-3" src="{{URL::asset('assets/images/orders/10.jpg')}}" alt="media1"> Headset</td>
													...
													<tr>
														<td class="font-weight-bold"><img class="w-7 h-7 rounded shadow ml-3" src="{{URL::asset('assets/images/orders/12.jpg')}}" alt="media1"> Watch</td>
													...
													<tr>
														<td class="font-weight-bold"><img class="w-7 h-7 rounded shadow ml-3" src="{{URL::asset('assets/images/orders/13.jpg')}}" alt="media1"> Branded Shoes</td>
													...
													<tr class="mb-0">
														<td class="font-weight-bold"><img class="w-7 h-7 rounded shadow ml-3" src="{{URL::asset('assets/images/orders/11.jpg')}}" alt="media1"> New EarPhones</td>
